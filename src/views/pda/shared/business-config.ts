...
export const PDA_BUSINESS_GROUPS: BusinessGroup[] = [
  {
    ...
    modules: [
      ...
      { key: 'devanning', label: '拆柜', badge: 3, icon: '\uD83D\uDEA2', route: 'wms_devanning-work', query: { biz: 'transfer' } },
  ...
  },
  {
    ...
    icon: '\uD83D\uDCE6',
    modules: [
      { key: 'putaway', label: '上库', badge: 22, icon: '\u2B06\uFE0F', route: 'wms_putaway-pda', query: { biz: 'transit', mode: 'BATCH' } },
  ...
  },
  {
    ...
    icon: '\uD83D\uDECD\uFE0F',
    modules: [
      { key: 'putaway', label: '上库', badge: 15, icon: '\u2B06\uFE0F', route: 'wms_putaway-pda', query: { biz: 'dropship', mode: 'SINGLE' } },
