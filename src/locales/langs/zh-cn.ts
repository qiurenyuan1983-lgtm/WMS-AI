const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'wms_warehouse-data': '仓库资料',
    wms_order: '订单管理',
    wms_inventory: '库存查询',
    wms_pallet: '卡板库存',
    'wms_inventory-lock': '锁定记录',
    'wms_inventory-transaction': '库存流水',
    'wms_pallet-outbound': '出库历史',
    'wms_inventory-visualization': '库存可视化',
    wms_zone: '库区管理',
    wms_location: '库位管理',
    'wms_devanning-order': '拆柜订单',
    'wms_devanning-group': '拆柜管理',
    'wms_devanning-order-detail': '拆柜订单详情',
    'wms_devanning-work': '人工拆柜',
    'wms_devanning-work-exec': '拆柜作业',
    'wms_devanning-dock-qr': '拆柜 Dock 码',
    'wms_inbound-group': '入库管理',
    'wms_inbound-order': '入库单列表',
    'wms_inbound-task': '入库任务',
    'wms_putaway-group': '上架管理',
    'wms_putaway-task': '上架任务列表',
    'wms_putaway-pda': 'PDA上架',
    ...
    'wms_outbound-group': '出库管理',
    'wms_outbound-order': '出库单列表',
    'wms_outbound-exec': '出库执行',
