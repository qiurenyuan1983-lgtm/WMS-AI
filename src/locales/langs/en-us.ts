const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'system_user-group': 'Users & Permissions',
    'system_config-group': 'System Config',
    'system_tenant-group': 'Tenant Management',
    'system_resource-group': 'Files & Clients',
    ...
    'system_theme-config': 'Theme Config',
    ...
    monitor_cache: 'Redis Cache Monitor',
    ...
    about: 'About',
    base: 'Basic Data',
    base_organization: 'Organization',
    base_goods: 'Products',
    'base_platform-group': 'Platforms',
    'base_business-data': 'Business Master',
    base_geo: 'Geography',
    base_finance: 'Finance',
    base_logistics: 'Logistics',
    base_yard: 'Yard Management',
    base_company: 'Companies',
    base_warehouse: 'Warehouses',
    base_sku: 'SKU',
    base_platform: 'Platform Config',
    'base_platform-address': 'Platform Addresses',
    base_channel: 'Channels',
    'base_business-type': 'Business Types',
    'base_value-added-service': 'Value-added Services',
    base_country: 'Countries',
    'base_state-province': 'States / Provinces',
    base_city: 'Cities',
    base_timezone: 'Timezones',
    'base_zip-code': 'Zip Codes',
    base_currency: 'Currencies',
    'base_exchange-rate': 'Exchange Rates',
    'base_fee-item': 'Fee Items',
    base_port: 'Ports',
    base_terminal: 'Terminals',
    'base_shipping-line': 'Shipping Lines',
    'base_shipping-route': 'Shipping Routes',
    base_vessel: 'Vessels',
    oms: 'OMS',
    oms_order: 'Order Center',
    oms_plan: 'Inbound Plan',
    oms_config: 'Rule Center',
    'oms_putaway-config': 'Inbound Config Rules',
    'oms_business-rule': 'Business Rules',
    'oms_approval-flow': 'Approval Flows',
    'oms_cargo-grouping-rule': 'Cargo Grouping Rules',
    'oms_zone-rule': 'Inbound Config Rules',
    'oms_platform-warehouse': 'Platform Warehouse',
    'oms_order-workbench': 'Order Workbench',
    'oms_platform-order': 'Platform Appointment Orders',
    'oms_ltl-order': 'LTL Orders',
    'oms_ltl-order-detail': 'LTL Order Detail',
    'oms_local-order': 'Local / Commercial',
    'oms_local-order-detail': 'Local Order Detail',
    'oms_cargo-order': 'Order Management',
    'oms_container-order': 'Container Management',
    'oms_inbound-plan': 'Inbound Plan',
    'oms_outbound-pool': 'Pending Trip Pool',
    'oms_platform-appointment': 'Platform Appointments',
    'oms_pre-outbound': 'Pre Outbound',
    'oms_outbound-order': 'Trip Orders',
    'oms_trip-order-group': 'Trip Order Management',
    'oms_trip-recommend': 'Auto Trip Recommend',
    'oms_trip-order-detail': 'Trip Order Detail',
    tms_supplier: 'Supplier Management',
    'tms_supplier-task': 'Supplier Task Center',
    'tms_supplier-drayage': 'Drayage Suppliers',
    'tms_supplier-linehaul': 'Linehaul Suppliers',
    'tms_supplier-ltl': 'LTL Suppliers',
    'tms_supplier-devanning-loading': 'Devanning/Loading Suppliers',
    'tms_supplier-quote': 'Supplier Quotes',
    'tms_supplier-account': 'Supplier Accounts',
    'tms_supplier-bill': 'Supplier Bills',
    'tms_supplier-fleet': 'Fleet & Equipment',
    'tms_supplier-kpi': 'Supplier KPI Dashboard',
    print: 'Print Center',
    print_workbench: 'Print Workbench',
    print_template: 'Templates',
    'print_template-pallet-label': 'Pallet Label Template',
    'print_template-devanning': 'Devanning Template',
    'print_template-bol': 'BOL Template',
    'print_template-report': 'Report Template',
    'print_template-invoice': 'Invoice Template',
    'print_template-carton': 'Carton Label Template',
    'print_template-location': 'Location Label Template',
    'print_template-custom': 'Custom Document Template',
    print_task: 'Print Tasks',
    print_batch: 'Batch Print',
    print_record: 'Print Records',
    print_printer: 'Printers',
    'print_template-version': 'Template Versions',
    print_rule: 'Print Rules',
    print_permission: 'Print Permissions',
    print_designer: 'Template Designer',
    comm: 'Communication Center',
    iec: 'Intelligent Employee Center',
    iec_dashboard: 'Employee Dashboard',
    'iec_role-config': 'Role Configuration',
    'iec_auto-flow': 'Auto Task Flows',
    iec_rpa: 'RPA Flow Manager',
    'iec_task-queue': 'Task Queue',
    iec_takeover: 'Manual Takeover',
    'iec_execution-log': 'Execution Logs',
    iec_credential: 'Credentials',
    iec_performance: 'Performance',
    portal: 'Customer Portal',
    portal_home: 'Overview',
    'portal_order-create': 'Create Order',
    portal_orders: 'My Orders',
    portal_inventory: 'Inventory & ASN',
    'portal_in-transit': 'In Transit',
    portal_containers: 'My Containers',
    'portal_transfer-ops': 'Transfer & Warehouse Ops',
    'portal_fee-confirm': 'Fee Confirmation',
    portal_bill: 'Billing',
    portal_files: 'Files',
    portal_comm: 'Communication',
    portal_exception: 'Exception Follow-up',
    portal_settings: 'Alerts & Preferences',
    comm_message: 'Messages',
    comm_contacts: 'Contacts',
    comm_group: 'Groups',
    'comm_business-session': 'Business Sessions',
    comm_todo: 'Todos',
    comm_file: 'Files',
    comm_meeting: 'Meetings',
    comm_ai: 'AI Assistant',
    comm_archive: 'Message Archive',
    comm_settings: 'Settings',
    wms: 'WMS',
    'wms_inventory-group': 'Inventory',
    'wms_transit-group': 'Transit Business',
    'wms_transfer-workbench': 'Transfer Workbench',
    'wms_warehouse-data': 'Location Settings',
    wms_order: 'Orders',
    wms_inventory: 'Inventory Query',
    wms_pallet: 'Warehouse Inventory',
    'wms_inventory-lock': 'Lock Records',
    'wms_inventory-transaction': 'Transactions',
    'wms_pallet-outbound': 'Loading History',
    'wms_outbound-mgmt': 'Outbound Management',
    'wms_trip-outbound-plan': 'Trip Outbound Plan',
    'wms_dock-auto-schedule': 'DOCK Auto Schedule',
    'wms_outbound-group': 'Trip Order Management',
    'wms_outbound-order': 'Trip Loading Slips',
    'wms_outbound-exec': 'Loading Execution',
    'wms_outbound-loading': 'Loading Tasks',
    'wms_driver-checkin': 'Driver Check-in',
    'wms_bol-pod': 'BOL / POD',
    'wms_trip-exception': 'Delivery Exceptions',
    'wms_trip-fee': 'Trip Fees',
    'wms_devanning-group': 'Devanning',
    'wms_devanning-work': 'Devanning Work',
    'wms_operation-group': 'Operations',
    'wms_operation-order': 'Operation Orders',
    'wms_vas-group': 'VAS',
    'wms_vas-task': 'VAS Tasks',
    'wms_stock-prep-group': 'Stock Prep',
    'wms_stock-prep-order': 'Stock Prep Orders',
    'wms_inventory-visualization': 'Inventory Floor Plan',
    wms_zone: 'Zones',
    wms_location: 'Locations',
    'wms_devanning-order': 'Devanning Orders',
    tms: 'TMS',
    tms_home: 'TMS Overview',
    tms_dispatch: 'Dispatch Workbench',
    tms_driver: 'Drivers',
    tms_vehicle: 'Vehicles',
    'tms_dock-board': 'DOCK Board',
    tms_pod: 'POD Upload',
    'tms_freight-settlement': 'Freight Settlement',
    tms_exception: 'Trip Exceptions',
    tms_log: 'TMS Logs',
    yms: 'Yard Management',
    yms_monitor: 'Monitor',
    'yms_dispatch-work': 'Dispatch',
    'yms_gate-work': 'Gate',
    'yms_yard-resource': 'Yard Resources',
    'yms_yard-operation': 'Yard Operations',
    'yms_exception-audit': 'Audit',
    'yms_gate-trailer-link': 'Trailer Link',
    yms_overview: 'Overview',
    yms_dispatch: 'Dispatch Board',
    yms_task: 'Tasks',
    yms_devanning: 'Devanning',
    yms_loading: 'DOCK Loading Board',
    'yms_internal-task': 'Internal Tasks',
    'yms_gate-checkin': 'Check-in',
    'yms_gate-check-out': 'Check-out',
    'yms_gate-in-yard': 'In Yard',
    yms_container: 'Containers',
    yms_trailer: 'Trailers',
    yms_zone: 'Yard Zones',
    'yms_yard-position': 'Positions',
    'yms_yard-inventory': 'Yard Inventory',
    yard_dock: 'Dock Setup',
    yard_zone: 'Yard Zones'
  },
  menu: {
    system_tenant: 'Tenant Management',
  ...
  page: {
    ...
    system: {
      ...
      menu: {
        ...
        batchSelectRequired: 'Please select menus first',
        batchEnableSuccess: 'Batch enable succeeded',
        batchDisableSuccess: 'Batch disable succeeded',
        deleteBlocked: 'Cannot delete while child menus or button permissions exist',
        dragSameLevelOnly: 'Only sibling drag sorting is supported',
        selectMenuHint: 'Select a menu on the left or click a row in the list',
        ...
        highRisk: 'High Risk',
        needConfirm: 'Confirm Required',
        auditLog: 'Audit Log',
        applicablePorts: 'Applicable Ports',
        applicableWarehouses: 'Applicable Warehouses',
        applicableRoles: 'Applicable Roles',
        applicableTenants: 'Applicable Tenants',
        affixTab: 'Affix Tab',
        openMode: 'Open Mode',
        updateTime: 'Update Time',
        tabBasic: 'Basic',
        ...
        exportSuccess: 'Menu exported successfully',
        importTip: 'Upload a JSON menu config exported from this system. Merge mode updates existing rows by menu code or permission key.',
        importMode: 'Import Mode',
        importModeMerge: 'Merge (recommended)',
        importModeReplace: 'Replace update',
        selectImportFile: 'Select JSON File',
        importFileRequired: 'Please select a file first',
        importFormatError: 'Invalid JSON menu config file',
        importCreated: 'Created',
        importUpdated: 'Updated',
        importSkipped: 'Skipped',
        applyButtonTemplate: 'Apply Button Template',
        buttonTemplate: 'Button Template',
        targetPage: 'Target Page',
        templateTip: 'Batch add button permissions from template. Existing permission keys will be skipped.',
        templatePageRequired: 'Please select a page menu (type C) first',
        templateApplyFailed: 'Failed to apply button template',
        highRiskConfirmTitle: 'High-risk Confirmation',
        highRiskConfirmContent: 'This operation is high risk. Please provide a confirmation remark.',
        highRiskSaveContent: 'Please provide a reason before saving high-risk menu/button permissions.',
        highRiskDeleteContent: 'Please provide a reason before deleting high-risk menu/button permissions.',
        highRiskBatchDisableContent: 'Please provide a reason before batch disabling high-risk menus.',
        confirmRemarkRequired: 'Confirmation remark is required',
        confirmRemarkPlaceholder: 'Describe the reason for audit trail',
