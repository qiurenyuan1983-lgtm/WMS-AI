const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'wms_warehouse-data': 'Warehouse Data',
    wms_order: 'Orders',
    wms_inventory: 'Inventory Query',
    wms_pallet: 'Pallet Inventory',
    'wms_inventory-lock': 'Lock Records',
    'wms_inventory-transaction': 'Transactions',
    'wms_pallet-outbound': 'Outbound History',
    'wms_inventory-visualization': 'Visualization',
    wms_zone: 'Zones',
