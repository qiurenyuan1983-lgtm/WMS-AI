...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  async function initConstantRoute() {
    ...
    if (authRouteMode.value === 'static') {
      ...
      // dynamic mode: also register constant routes from dynamicConstantRoutes
      // (e.g. H5 public pages like /h5/yard/driver-checkin that need no login)
      const dynamicRoute = createDynamicRoutes();
      addConstantRoutes([...staticRoute.constantRoutes, ...dynamicRoute.constantRoutes]);
    }
