...
declare namespace App {
  ...
  namespace I18n {
    ...
    type Schema = {
      ...
      route: Partial<Record<I18nRouteKey, string>> & Record<string, string>;
      ...
      page: {
        ...
        system: {
          ...
          menu: {
            ...
            batchEnable: string;
            batchDisable: string;
            batchSelectRequired: string;
            batchEnableSuccess: string;
            batchDisableSuccess: string;
            deleteBlocked: string;
            dragSameLevelOnly: string;
            selectMenuHint: string;
            parentMenu: string;
            menuNameEn: string;
            menuCode: string;
            permName: string;
            ...
            targetPage: string;
            templateTip: string;
            templatePageRequired: string;
            templateApplyFailed: string;
            highRiskConfirmTitle: string;
            highRiskConfirmContent: string;
            highRiskSaveContent: string;
            highRiskDeleteContent: string;
            highRiskBatchDisableContent: string;
            confirmRemarkRequired: string;
            confirmRemarkPlaceholder: string;
            parentId: string;
            iconType: string;
            menuName: string;
            icon: string;
