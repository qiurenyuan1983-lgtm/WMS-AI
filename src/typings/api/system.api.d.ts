...
declare namespace Api {
  ...
  namespace System {
    ...
    type RoleOrgScope = {
      roleId: CommonType.IdType;
      orgScope: 'ALL' | 'COMPANY' | 'WAREHOUSE';
      companyIds: CommonType.IdType[];
      warehouseIds: CommonType.IdType[];
    };

    type RoleOrgScopeOperateParams = CommonType.RecordNullable<RoleOrgScope>;

    /** authorized company option */
    ...
    /** authorized warehouse option */
    type OrgWarehouseOption = {
      id: CommonType.IdType;
    ...
    /** current top organization context */
    type OrgScopeCurrent = {
    ...
    type OrgScopeCurrentOperateParams = CommonType.RecordNullable<Pick<OrgScopeCurrent, 'companyId' | 'warehouseId'>>;
